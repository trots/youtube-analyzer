...
class Settings:
    ...
    ExportFollowTableFiltersXlsx = SettingsKey("export_follow_table_filters_xlsx", False, is_global=True)
    ExportFollowTableFiltersCsv = SettingsKey("export_follow_table_filters_csv", False, is_global=True)
    ExportFollowTableFiltersHtml = SettingsKey("export_follow_table_filters_html", False, is_global=True)
    ExportFollowTableFiltersTxt = SettingsKey("export_follow_table_filters_txt", False, is_global=True)
    ExportFollowTableColumnsXlsx = SettingsKey("export_follow_table_columns_xlsx", False, is_global=True)
    ExportFollowTableColumnsCsv = SettingsKey("export_follow_table_columns_csv", False, is_global=True)
    ExportFollowTableColumnsHtml = SettingsKey("export_follow_table_columns_html", False, is_global=True)
    ExportFollowTableColumnsTxt = SettingsKey("export_follow_table_columns_txt", False, is_global=True)
    ExportSelectedColumnsXlsx = SettingsKey("export_selected_columns_xlsx", None, is_global=True)
    ExportSelectedColumnsCsv = SettingsKey("export_selected_columns_csv", None, is_global=True)
    ExportSelectedColumnsHtml = SettingsKey("export_selected_columns_html", None, is_global=True)
    ExportSelectedColumnsTxt = SettingsKey("export_selected_columns_txt", None, is_global=True)
    ExportColumnOrderXlsx = SettingsKey("export_column_order_xlsx", None, is_global=True)
    ExportColumnOrderCsv = SettingsKey("export_column_order_csv", None, is_global=True)
    ExportColumnOrderHtml = SettingsKey("export_column_order_html", None, is_global=True)
    ExportColumnOrderTxt = SettingsKey("export_column_order_txt", None, is_global=True)
    ExportIncludeHeaderXlsx = SettingsKey("export_include_header_xlsx", True, is_global=True)
    ExportIncludeHeaderCsv = SettingsKey("export_include_header_csv", True, is_global=True)
