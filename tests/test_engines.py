    ...
    def test_youtube_grep_engine(self):
        for count in range(4):
            ...
            if count > 0:
                ...
                self.assertEqual(model.get_field_data(0, ResultFields.VideoPublishedTime), "8 hours ago")
                self.assertEqual(model.get_field_data(0, ResultFields.VideoDuration), "00:12:34")
                self.assertEqual(model.get_field_data(0, ResultFields.VideoViews), 123)
                self.assertEqual(model.get_field_data(0, ResultFields.VideoLink), "https://video_1")
                self.assertEqual(model.get_field_data(0, ResultFields.ChannelTitle), "First channel title")
                self.assertEqual(model.get_field_data(0, ResultFields.ChannelLink), "https://fchannel")
                self.assertEqual(model.get_field_data(0, ResultFields.ChannelSubscribers), 30)
                self.assertEqual(model.get_field_data(0, ResultFields.ChannelJoinedDate), "2020-05-18")
                self.assertEqual(model.get_field_data(0, ResultFields.ViewRate), "410.0%")
                self.assertEqual(model.get_field_data(0, ResultFields.VideoPreviewLink), "https://thumb_1.png")
                self.assertEqual(model.get_field_data(0, ResultFields.ChannelLogoLink), "https://logo_1.png")
                self.assertEqual(model.get_field_data(0, ResultFields.VideoTags), ["word1", "word2"])
                self.assertEqual(model.get_field_data(0, ResultFields.VideoDurationTimedelta), timedelta(seconds=754))
            if count > 1:
                self.assertEqual(model.get_field_data(1, ResultFields.VideoTitle), "Second video")
                self.assertEqual(model.get_field_data(1, ResultFields.VideoPublishedTime), "3 hours ago")
                self.assertEqual(model.get_field_data(1, ResultFields.VideoDuration), "00:23:12")
                self.assertEqual(model.get_field_data(1, ResultFields.VideoViews), 800)
                self.assertEqual(model.get_field_data(1, ResultFields.VideoLink), "https://video_2")
                self.assertEqual(model.get_field_data(1, ResultFields.ChannelTitle), "First channel title")
                self.assertEqual(model.get_field_data(1, ResultFields.ChannelLink), "https://fchannel")
                self.assertEqual(model.get_field_data(1, ResultFields.ChannelSubscribers), 30)
                self.assertEqual(model.get_field_data(1, ResultFields.ChannelJoinedDate), "2020-05-18")
                self.assertEqual(model.get_field_data(1, ResultFields.ViewRate), "2666.67%")
                self.assertEqual(model.get_field_data(1, ResultFields.VideoPreviewLink), "https://thumb_2.png")
                self.assertEqual(model.get_field_data(1, ResultFields.ChannelLogoLink), "https://logo_1.png")
                self.assertEqual(model.get_field_data(1, ResultFields.VideoTags), ["word1", "word2"])
                self.assertEqual(model.get_field_data(1, ResultFields.VideoDurationTimedelta), timedelta(seconds=1392))
            if count > 2:
                self.assertEqual(model.get_field_data(2, ResultFields.VideoTitle), "Third video")
                self.assertEqual(model.get_field_data(2, ResultFields.VideoPublishedTime), "10 hours ago")
                self.assertEqual(model.get_field_data(2, ResultFields.VideoDuration), "00:36:47")
                self.assertEqual(model.get_field_data(2, ResultFields.VideoViews), 409)
                self.assertEqual(model.get_field_data(2, ResultFields.VideoLink), "https://video_3")
                self.assertEqual(model.get_field_data(2, ResultFields.ChannelTitle), "First channel title")
                self.assertEqual(model.get_field_data(2, ResultFields.ChannelLink), "https://fchannel")
                self.assertEqual(model.get_field_data(2, ResultFields.ChannelSubscribers), 30)
                self.assertEqual(model.get_field_data(2, ResultFields.ChannelJoinedDate), "2020-05-18")
                self.assertEqual(model.get_field_data(2, ResultFields.ViewRate), "1363.33%")
                self.assertEqual(model.get_field_data(2, ResultFields.VideoPreviewLink), "https://thumb_3.png")
                self.assertEqual(model.get_field_data(2, ResultFields.ChannelLogoLink), "https://logo_1.png")
                self.assertEqual(model.get_field_data(2, ResultFields.VideoTags), ["word1", "word2"])
                self.assertEqual(model.get_field_data(2, ResultFields.VideoDurationTimedelta), timedelta(seconds=2207))
